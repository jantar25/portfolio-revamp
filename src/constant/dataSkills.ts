export const dataSkills: { name: string; rate: string }[] = [
  { name: 'UI and UX', rate: '95' },
  { name: 'Software Development', rate: '95' },
...
export const frameworksLabraries: { name: string; icon: string }[] = [
...
export const tools: { name: string; icon: string }[] = [
  ...
  { name: 'Kali Linux', icon: 'https://img.icons8.com/color/480/kali-linux.png' },
  ...
  { name: 'Kibana', icon: 'https://cdn.jsdelivr.net/gh/devicons/devicon/icons/androidstudio/androidstudio-original.svg' },
  { name: 'Elastic Search', icon: 'https://cdn.jsdelivr.net/gh/devicons/devicon/icons/elasticsearch/elasticsearch-original.svg' },
