...
const SliderItem: React.FC<Item> = ({ name, icon }) => {
  return (
    <div className="w-full h-20 border dark:border-lines-dark border-lines-light dark:bg-background-dark_extension bg-background-light_extension rounded-3xl shadow-md
